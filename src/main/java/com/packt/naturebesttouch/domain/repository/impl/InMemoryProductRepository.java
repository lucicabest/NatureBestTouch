...
//		}
	...
	public Product getProductBycategoryAndPrice(String category, String price) {
		String SQL = "SELECT * FROM PRODUCTS WHERE CATEGORY =:category AND UNIT_PRICE =:price";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("category", category);
	...
	public List<Product> getProductsByCategoryByFilters(String category, Map<String, String> filterParams, String brand) {
		String SQL = "SELECT * FROM PRODUCTS WHERE MANUFACTURER =:brand AND CATEGORY =:category AND UNIT_PRICE BETWEEN :low AND :high";
...
//	@Override
//	public List<Product> getProductsByCategoryByFilter(String category, Map<String, String> filterParams,
//			String brands) {
//		// TODO Auto-generated method stub
//
//		String SQL = "SELECT * FROM PRODUCTS WHERE CATEGORY IN (:category) AND MANUFACTURER IN (:brands) AND UNIT_PRICE BETWEEN (:low) AND (:high) ";
//		Map<String, Object> params = new HashMap<String, Object>();
//		params.put("category", category);
